...
<style type="text/css">
  #pac-input-cascade{
    ...
    <div class="aground-img-pop" id="aground-img-pop" onclick="closePopUpImg()">
    ...
    <script type="text/javascript">
        ...
        function makeFileList() {
            ...
            for (var i = 0; i < input.files.length; i++) {
                ...
                li.innerHTML = '<p><strong><i class="fa fa-times" aria-hidden="true"></i></strong>'+input.files[i].name+'</p>';
                ul.appendChild(li);
            }
            if(!ul.hasChildNodes()) {
                var li = document.createElement("li");
                    ...
                    for(var i=0;i<oData.length;i++) { // génération de la deuxième liste déroulante
                        ...
                        content+= `<div class="commentary dvid">
                          <div class="com-prof bxd12 bxt12 bxm12">
                            <div class="top-com"><h2 class="name-profile">`+oData[i].name+`<strong> Le `+jour+`/`+mois+`/`+annee+` à `+heureCom+`</strong></h2></div>
        ...
        function initMap() {
            ...
            @if ($zoneZoom != null)
                latMap = {{$zoneZoom->latNWzone}};
            lngMap = {{$zoneZoom->longNWzone}};
            @endif
                ...
                req.onreadystatechange = function() {
                    ...
                    if(this.readyState == this.DONE && this.status == 200 ) {
                        ...
                        var contentString = '<div id="content">'+
                            '<div id="siteNotice">'+
                            '</div>'+
                            '<h1 id="firstHeading" class="firstHeading">Informations de la zone : </h1>'+
                            '<div id="bodyContent">'+
